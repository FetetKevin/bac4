<div class="container-fluid">
    <div class="panel panel-warning" id="f1">
        ...
        <div class="panel-body">
            ...
            {  ?>
                ...
                <th style="color:orange;"><?=$tableHeading[$i]?></th>
            <?php }
	...
	ORDER BY id_video";
        ...
        <div class="panel-footer">Liste des <span style="color:orange;">Videos En Attentes</span></div>
    </div>
</div>
